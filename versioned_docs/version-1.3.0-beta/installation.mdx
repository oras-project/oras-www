...
If you want to install ORAS on an ARM64-based Linux machine, you can download it from `https://github.com/oras-project/oras/releases/download/v1.3.0-beta.4/oras_1.3.0-beta.4_linux_arm64.tar.gz`.
...
If you want to install ORAS on an Intel-based Mac, you can download it from `https://github.com/oras-project/oras/releases/download/v1.3.0-beta.4/oras_1.3.0-beta.4_darwin_amd64.tar.gz`.
...
```bash
winget install oras --version 1.3.0-beta.4
```
...
```
docker run -it --rm -v $(pwd):/workspace ghcr.io/oras-project/oras:v1.3.0-beta.4 help
```
:::note
...
```
alias doras='docker run -it --rm -v $(pwd):/workspace ghcr.io/oras-project/oras:v1.3.0-beta.4'
```
...
Git commit:     582ae373493985fb8cda60a4306b52d4e9f70b8e
