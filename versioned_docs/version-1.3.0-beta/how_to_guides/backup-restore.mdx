...
When moving from one container registry provider to another, the pair of commands enables full an entire repository export and rehydration, preserving tags, manifests, layers, and referrers.
...
```bash
oras backup ghcr.io/chocolate-labs/oras-cli --output oras-cli.tar
```
...
Restore all tags and referrers from the tarball to a sample registry. Make sure you have logged in to the registry using `oras login` or `docker login`.

```bash
oras restore docker.io/feynmanzhou/oras-cli --input oras-cli.tar
```
...
Successfully restored 3 tag(s) to "docker.io/feynmanzhou/oras-cli" in 31s
```

List the image and its referrers in the registry to check its completeness: 

```bash
oras discover docker.io/feynmanzhou/oras-cli:v1.2.3
```

```console
docker.io/feynmanzhou/oras-cli@sha256:7ab47454c95a177cbbccea9569abde6ccfd6b1367bc6407032fe78224cacc86e
├── application/vnd.cncf.notary.signature
│   └── sha256:cb90b160364b291474fc44249e59b01fd626bb25b2d8842b3345b9f3c06ea4ba
│       └── [annotations]
│           ├── io.cncf.notary.x509chain.thumbprint#S256: '[c788b80157a0cee4f7e9fb60fd533a7079181f4d74a2b62881dfbe320ccb13f9,9b1894f223d934cbd6575af3c6e1f6096b9221a7da132185f5a5cdc92235b5dc,23ffe2b8bdb9a1711515d4cffda04bc7f793d513c76c243f1020507d8669b7db]'
