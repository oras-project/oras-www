...
When moving from one container registry provider to another, the pair of commands enables a full repository export and rehydration, preserving tags, manifests, layers, and referrers.
