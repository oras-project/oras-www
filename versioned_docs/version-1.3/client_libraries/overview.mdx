...
This section defines a shared goals and roadmap framework for all ORAS SDKs, grouping features into Core, Recommended, and Optional to align implementation priorities and user expectations.
