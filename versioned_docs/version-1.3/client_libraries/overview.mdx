...
This section defines a shared goals and roadmap framework for all ORAS SDKs, grouping features into Core (Must), Recommended (Should), and Optional (May) to align implementation priorities and user expectations.
