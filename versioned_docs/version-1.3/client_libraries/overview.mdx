...
- **Extended Registry Client**
   - Support widely recognized APIs, such as APIs defined in [Docker Registry HTTP API V2](https://distribution.github.io/distribution/spec/api/) which are not part of the OCI Distribution Spec (e.g., repository catalog).
