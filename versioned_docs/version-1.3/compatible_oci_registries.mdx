...
- Login to your registry
  - [Install doctl and authenticate it with an API token](https://docs.digitalocean.com/reference/doctl/how-to/install/)
  - Do registry login

    ```shell
    doctl registry login
    ```
- Pushing artifacts to DOCR:

  ```shell
  oras push registry.digitalocean.com/coolreg-simple/plain-artifact:v1 artifact.txt:text/plain
  ```

- Pulling artifacts from DOCR:

  ```shell
  oras pull registry.digitalocean.com/coolreg-simple/plain-artifact:v1
  ```
