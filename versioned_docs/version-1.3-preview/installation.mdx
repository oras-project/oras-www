...
If you want to install ORAS on an ARM64-based Linux machine, you can download it from `https://github.com/oras-project/oras/releases/download/v1.3.0-rc.2/oras_1.3.0-rc.2_linux_arm64.tar.gz`.
...
If you want to install ORAS on an Intel-based Mac, you can download it from `https://github.com/oras-project/oras/releases/download/v1.3.0-rc.2/oras_1.3.0-rc.2_darwin_amd64.tar.gz`.
...
```
docker run -it --rm -v $(pwd):/workspace ghcr.io/oras-project/oras:v1.3.0-rc.2 help
```
:::note
...
```
alias doras='docker run -it --rm -v $(pwd):/workspace ghcr.io/oras-project/oras:v1.3.0-rc.2'
```
...
Git commit:     99b6e1ec698937a5b7e0984e747c7c61c6f2cbdd
