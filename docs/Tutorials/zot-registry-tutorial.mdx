---
title: Tutorial to distribute an OCI artifact to Zot Registry using ORAS CLI
sidebar_position: 0
---
...
It is to be noted that in case of zot, authentication is disabled by default. Still, if you wish to authenticate, you can use [`oras login`](https://oras.land/docs/CLI_Reference/oras_login) to do so.
...
Distributing OCI artifacts to OCI registries aids in collaboration and code sharing. It enables teams to acquire and use through a standardized artifact interface. This is why it is considered to play a crucial role in maintaining consistency among teams.