...
- Join us at [CNCF Slack](https://cloud-native.slack.com) under the **#oras** channel. In case you haven't join the CNCF workspace yet, you can follow the steps mentioned in [this section](#joining-the-slack-channel).
