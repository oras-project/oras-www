...
To report a security vulnerability, please contact one or more (ORAS maintainers)[https://github.com/oras-project/community/blob/main/OWNERS.md] via email or Slack with the vulnerability details. Please `do not` open a public issue describing the vulnerability.
