...
* [Contributor Ladder](#contributor-ladder)
    ...
    * [Organization Owners](#oras-organization-owners)
...
Changes to organization owners abide by the following:

* Any subproject owner is eligible for a position as an organization owner.
* No one company or organization can employ a simple majority of the organization owners.
* An organization owner may step down by submitting an issue stating their intent and they will be moved to emeritus.
* organization owners MUST remain active on the project. 
If they are unresponsive for > 6 months, 
they will lose organization ownership unless a super-majority of the other organization owners agrees to extend the period to be greater than 6 months.
* When there is an opening for a new organization owner, 
...
the subproject owners may vote
    ...
    * Only current organization owners are eligible to vote via casting a single vote each via a +1 comment on the nomination issue.
    * Once a super-majority has been reached the owner elect must complete onboarding prior to becoming an official ORAS owner.
    * Once the owner onboarding has been completed, a pull request is made on the repository adding the new owner to the OWNERS file.
* When an organization owner steps down, they become an emeritus owner.

Once an organization owner is elected, 
...
Any existing subproject owner is eligible to become an organization owner.

The organization Owners will select a chair to set agendas and call meetings of the organization Owners. 
Chairs will serve a term of 6 months, 
once the term is complete organization owners will select a subsequent chair.
...
Those cases can be escalated to the organization owners.
...
* When a subproject has no owners, the ORAS organization owners become responsible for it and may archive the subproject or find new owners
