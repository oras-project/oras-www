...
### Owners Structure
There are two types of owners in the ORAS project organized hierarchically. 
* ORAS org owners oversee the overall project and its health. 
...
Changes in ORAS Org owners have to be announced via an 
...
ORAS owners adhere to the requirements and responsibilities set forth in the respective ORAS Org Owners and Subproject Owners. 
