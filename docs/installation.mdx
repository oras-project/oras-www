...
You can download all of the artifacts uploaded to the new [GitHub release](https://github.com/oras-project/oras/releases) locally.

The checksum can be performed using the following command:

```
shasum -c oras_${version}_checksums.txt
```

If you get an 'OK' in your output, you may presume that the file is original and unmodified. 