...
If you want to install ORAS on an ARM64-based Linux machine, you can download it from `https://github.com/oras-project/oras/releases/download/v1.0.1/oras_1.0.1_linux_arm64.tar.gz`.
...
If you want to install ORAS on an Intel-based Mac, you can download it from `https://github.com/oras-project/oras/releases/download/v1.0.1/oras_1.0.1_darwin_amd64.tar.gz`.
...
```
docker run -it --rm -v $(pwd):/workspace ghcr.io/oras-project/oras:v1.0.1 help
```
:::note
