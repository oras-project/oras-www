  ...
  themeConfig:
    ...
    ({
      ...
      announcementBar: {
        id: 'announcement_bar',
        content:
          `⭐ If you like ORAS Project, give it a star on <a target="_blank" rel="noopener noreferrer" href="https://github.com/oras-project/oras">GitHub</a> and follow us on <a target="_blank" rel="noopener noreferrer" href="https://x.com/orasproject">${TwitterSvg}</a>`,
