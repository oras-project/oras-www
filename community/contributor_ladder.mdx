...
* Responsibilities include:
    ...
    * Follow the project [contributing guide](/community/contributing_guide.mdx)
...
You can follow the instructions in the [community resources](/community/community_resources/#joining-the-slack-channel)
to join it.