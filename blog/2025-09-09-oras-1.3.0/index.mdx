...
With `oras manifest index create`, `oras manifest index update`, you can easily assemble, update, distribute, and annotate multi-architecture images and artifacts across local environments and registries.
...
Formatted output transforms ORAS from a simple terminal user tool to a **DevOps-friendly, integrable** developer tool.
