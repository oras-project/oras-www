...
With `oras backup` and `oras restore`, ORAS now lets you save your registry content into local directories or tarballs (OCI image layout format) as a snapshot and **restore to any registry**. All manifests and optionally any tags, referrers will be included within the the backup.
